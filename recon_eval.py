...
def parse():
    ...
    parser.add_argument('-n', '--net_name', type=Path, default='test_Unet')
    parser.add_argument('-p', '--path_data', type=Path, default='/Data/leaderboard/')
    parser.add_argument('--in-chans', type=int, default=1)
    parser.add_argument('--out-chans', type=int, default=1)
    parser.add_argument('--input_key', type=str, default='image_input')
